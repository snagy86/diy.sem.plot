...
Below is a brief example of what the function is capable of. For more examples plus a full explanation of work flow and available arguments see vignette("diy.sem.plot")`. 
