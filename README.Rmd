...
You map out where nodes go using simple coordinates and specify the attachment points (sides of the relevant nodes) where each path begins and ends. A range of fine-tuning options are included, facilitating the creation of a path diagram exactly as you envision it, entirely within R.
