...
diy.sem.plot allows you to manually plot fully customizable path diagrams for structural equation models (SEM) using the diy_paths() function. It avoids the inflexibility of automated SEM plotting tools and the tedium of drawing diagrams in external applications.
