...
Lastly, the plot did not render properly within the margins (i.e. path estimates are cut off at edges). We can fix this by increasing the margins via `margin_x` and `margin_y` arguments, which are currently set to 0.5.
