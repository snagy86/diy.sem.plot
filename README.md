...
allows you to manually plot fully customisable path diagrams for
structural equation models (SEM) using the `diyPaths()` function. It
avoids the inflexibility of automated SEM plotting tools and the tedium
of drawing diagrams in external applications.
